        ...
        return (
          <Card key={g.id} style={{ marginBottom: 14, overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", borderTop: "0.5px solid " + T.sep }}>
              ...
              <button onClick={function() { setEditGoal(g); setEditForm({ name: g.name, target: String(g.target), deadline: g.deadline || "" }); }}
