            ...
            {(function() {
              ...
              return (
                <div style={{ display: "flex", gap: 6, background: "rgba(0,0,0,0.04)", borderRadius: 12, padding: 4, marginBottom: 14 }}>
                  ...
                  <button onClick={function() { if (canRemove) setAddMode("remove"); }}
                    style={{ flex: 1, border: "none", borderRadius: 9, padding: "9px 0", cursor: canRemove ? "pointer" : "default", fontFamily: UI, fontSize: 14, fontWeight: 700, background: addMode === "remove" ? T.red : "transparent", color: addMode === "remove" ? "#fff" : (canRemove ? T.ink2 : T.ink3), opacity: canRemove ? 1 : 0.5 }}>
                    {tr("removeMoney")}
                  </button>
                </div>
              );
